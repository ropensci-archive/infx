...
are currently implemented as they mostly deal with modifying metadata and creating new aggregation reports. The main focus of this package however is retrieving data and therefore only methods from the following API sections have been implemented.
